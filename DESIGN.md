...
Nous utilisons également des exceptions standards (Exception) pour signaler des incohérences internes, par exemple lorsqu'une méthode retourne un type inattendu (comme un élément qui devrait être un Event mais ne l'est pas). 