...
public class IcsWriter implements OutputWriter {
  ...
  private void writeTodo(Todo t, PrintWriter pw) {
    ...
    if (t.getOrganizerName() != null && t.getOrganizerMail() != null) {
      pw.println("ORGANIZER;CN=" + t.getOrganizerName() + ":" + t.getOrganizerMail());
   ...
   */
  private void writeField(PrintWriter pw, String fieldName, Object value) {
    if (value != null) {
   ...
   */
  private void writeDateTimeField(PrintWriter pw, String fieldName, LocalDateTime value) {
    if (value != null) {
   ...
   */
  private void writeDateField(PrintWriter pw, String fieldName, LocalDate value) {
    if (value != null) {
