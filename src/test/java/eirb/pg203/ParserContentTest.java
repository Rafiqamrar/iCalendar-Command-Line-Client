...
class ParserContentTest {
  ...
  void testParse_SimpleEvent_Content() {
    ...
    assertEquals(
        Utils.dateTimeFormatter("20250101T090000Z"), event.getStart(), "DTSTART incorrect");
  ...
  void testParse_RealTodo_Content() {
    ...
    assertEquals(
        Utils.dateTimeFormatter("20251104T204504Z"), todo.getCompleted(), "Completed incorrect");
    assertEquals(Utils.dateTimeFormatter("20251104T204504Z"), todo.getLastModified(),
        "Last-modified incorrect");
    assertEquals(
        Utils.dateTimeFormatter("20251104T204504Z"), todo.getDtStamp(), "DTSTAMP incorrect");
  ...
  void testParse_RealEvent_Content() {
    ...
    assertEquals(
        Utils.dateTimeFormatter("20251110T151000Z"), event.getStart(), "DTSTART incorrect");
    ...
    assertEquals(
        Utils.dateTimeFormatter("20251104T215832Z"), event.getDtStamp(), "DTSTAMP incorrect");
    assertEquals(
        Utils.dateTimeFormatter("19700101T000000Z"), event.getCreated(), "CREATED incorrect");
    assertEquals(Utils.dateTimeFormatter("20251104T215832Z"), event.getLastModified(),
        "LAST-MODIFIED incorrect");
  ...
  void testParse_MultipleItems_Content() {
    ...
    assertEquals(
        Utils.dateTimeFormatter("20250101T100000Z"), event1.getStart(), "EVENT1 DTSTART incorrect");
    ...
    assertEquals(
        Utils.dateTimeFormatter("20250102T100000Z"), event2.getStart(), "EVENT2 DTSTART incorrect");
  }
